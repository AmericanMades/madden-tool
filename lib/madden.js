...
// Real Madden position codes confirmed from roster data, in a
// sensible display order (offense, then defense, then special
// teams) — used to sort position lists and filter dropdowns
// consistently across pages.
export const POSITION_ORDER = [
  "QB", "HB", "FB", "WR", "TE", "LT", "LG", "C", "RG", "RT",
  "LEDG", "REDG", "DT", "MIKE", "SAM", "WILL", "CB", "FS", "SS",
  "K", "P", "LS",
];

export function sortedDistinctPositions(players) {
